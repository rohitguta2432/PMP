...
namespace PMP
{
	public class EstimatedExpenseDetailDTO
    {
		public System.Int32 EstimatedExpenseID { get; set; }
        ...
        public static System.Linq.Expressions.Expression<Func< EstimatedExpenseDetail,  EstimatedExpenseDetailDTO>> SELECT =
            x => new  EstimatedExpenseDetailDTO
            {
                EstimatedExpenseID = x.EstimatedExpenseID,
                Units = x.Units,
                UnitRate = x.UnitRate,
                Cost = x.Cost,
